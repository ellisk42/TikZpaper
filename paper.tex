...
\begin{figure}[H]
  \begin{minipage}[t]{8.25cm}
    \begin{tabular}{llll}
      ...
      \end{tabular}
    \subcaption{Left to right: Ising model, recurrent network architecture, figure from a deep learning textbook \cite{Goodfellow-et-al-2016}, graphical model}
  \end{minipage}
...
%Describing Sketch's program synthesis
%algorithm is beyond the scope of this paper; see~\cite{solar2008program}.
At a
