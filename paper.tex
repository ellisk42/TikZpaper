...
for an image.
Learning this prior over programs modestly improves our Top-1 accuracy from 57\% to \textbf{experiment is still running},
but recall from Fig.~\ref{drawingIntersectionOverUnion}
that the best improvement in accuracy we could possibly get is 65\%.
