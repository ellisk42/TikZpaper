...
\section{Neural architecture for inferring drawing drawing commands}\label{neuralNetworkSection}
...
\begin{figure}[H]
  \begin{minipage}[t]{8.25cm}
    \begin{tabular}{llll}
      ...
      \end{tabular}
    \subcaption{Left to right: Ising model, recurrent network architecture, a figure from a deep learning textbook, graphical model}
  \end{minipage}
