...
How could an agent go from noisy,
...
\begin{figure}
  \begin{minipage}[t]{10cm}
    \includegraphics[width = 10cm]{figures/editDistance.png}
  \end{minipage}\\
  \begin{minipage}[t]{10cm}
    \includegraphics[width = 10cm]{figures/accuracy.png}
  \end{minipage}\\
  \begin{minipage}[t]{10cm}
    \includegraphics[width = 10cm]{figures/time.png}
    \end{minipage}
  \end{figure}
...
We see this system as a first step towards more powerful graphics
program synthesizers.  We look forward to, in the near future, being
able to hand-draw our figures and automatically convert them into
publication-quality \LaTeX code.
