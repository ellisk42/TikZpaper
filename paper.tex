...
\subcaption{}
  ...
  \begin{minipage}[t]{0.3\linewidth}
    ...
    \subcaption{}
  \end{minipage}
  \caption{(a): Model learns to convert hand drawings (top) into \LaTeX~(bottom). (b) Synthesizes high-level \emph{graphics program} from hand drawing.~\remark{Kevin to Dan: how about this placement?}}\label{firstPageExamples}
  \end{figure}
...
Completely we train our likelihood surrogate to approximate the symmetric difference:
\begin{equation}
-\log L_{\text{learned}}(\text{render}(T_1)|\text{render}(T_2))\approx |T_1 - T_2| + |T_2 - T_1|
  \end{equation}
...
We also penalize using more constants; see supplement.
