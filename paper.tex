...
Because our model assumes that objects lie on a $16\times 16$ grid,
...
As the model sometimes makes mistakes on hand drawings,
...
Modeling drawings using programs opens up new ways to measure similarity them.
...
In the near future, we believe it will be possible to produce professional-looking figures by drawing them and then letting an artificially-intelligent agent write the corresponding code.
