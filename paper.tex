...
sense, this model is like an autoregressive variant of AIR. When we
have the generative model (the rendering function), we need not solve
an unsupervised or reinforcement learning problem.
