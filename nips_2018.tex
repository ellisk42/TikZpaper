...
%  \includegraphics[width = \textwidth]{figures/extrapolationMatrix3.png}  
  ...
  \label{extrapolationFigure}\vspace{-0.25cm}
  \end{figure}
...
\subsubsection*{Acknowledgments} We are grateful for advice from Will Grathwohl and Jiajun Wu on the design of the neural architecture. Work funded by NSF GRFP (K.E.) and NSF Award 
\#1753684 (D.R.)
