...
\begin{table}[h]
  ...
  \begin{minipage}[c]{0.5\textwidth}
    \caption{Time to synthesize a minimum cost program. Sketch: out-of-the-box performance of the Sketch~\citep{solar2008program} program synthesizer. DC: Baseline that predicts program components, trained like~\cite{BalGauBroetal16}. Oracle:  upper bounds  the performance of any search policy. Learned policy: ours  %% $\infty = $ timeout. Red dashed line is median time.
           evaluated using 20-fold cross validation.}\label{policyEvaluation}
    \end{minipage}
\end{figure} 
