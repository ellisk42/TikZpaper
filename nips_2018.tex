...
this means that we run many different
...
\begin{figure}\centering
  \begin{minipage}[c]{0.45\textwidth}
    \begin{tikzpicture}[scale=0.8]
        \node[anchor = west] at (1,4.25) {Entire program search space};
        \footnotesize
    \draw[fill = yellow,fill opacity = 0.15,draw = black] (0,0) rectangle (7,4);
    \draw [fill = yellow, opacity = 0.2] (0,0)--(0,2)--(7,0)--(0,0);
    \draw [fill = yellow, opacity = 0.4] (0,4)--(0,1)--(6,4);
    \draw [fill = yellow, opacity = 0.6] (4.5,4)--(5.2,0)--(7,0)--(7,4);
    \draw (0,2) -- node[below,sloped]{short programs} (7,0);
    \draw (0,2) -- node[above,sloped]{long programs} (7,0);
    \draw[align=center] (4.5,4) -- node[above,sloped]{programs w/ \\reflections} (5.2,0);
    \draw[align=center] (0,1) -- node[above,sloped]{ programs w/ \\loops} (6,4);
...
\begin{figure}[H]\centering
  ...
  \label{extrapolationFigure}%\vspace{-0.8cm}
  \end{figure}
...
\subsubsection*{Acknowledgments} We are grateful for advice from Will Grathwohl and Jiajun Wu on  the neural architecture, and for funding from NSF GRFP, NSF Award 
...
\subsubsection*{Code, data, and drafts}
A longer version of this paper is available at~\url{https://arxiv.org/abs/1707.09627}.
The code and data are available at~\url{https://github.com/ellisk42/TikZ}.
